...
const GUEST_PREFIXES = ['STAY-DATES-', 'PHASE1C2C-', 'BOOKING-COMP-', 'AVAIL-REG-', 'AVAILREG-'];
const CORRELATION_PREFIXES = ['STAY-DATES-', 'PHASE1C2C-', 'BOOKING-COMP-', 'AVAIL-REG-', 'AVAILREG-'];
