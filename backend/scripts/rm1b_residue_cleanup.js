...
const GUEST_PREFIXES = ['STAY-DATES-', 'PHASE1C2C-', 'BOOKING-COMP-', 'AVAIL-REG-', 'AVAILREG-', 'RM1C-'];
const CORRELATION_PREFIXES = ['STAY-DATES-', 'PHASE1C2C-', 'BOOKING-COMP-', 'AVAIL-REG-', 'AVAILREG-', 'RM1C-', 'BOOKING-OK-'];
