...
async function main() {
  ...
  await test('scenario-1: all gates pass => eligible true', async () => {
    const client = createMockClient({
      reservations: [{ id: 1, property_id: 1, room_id: 10 }],
  ...
  await test('scenario-4: partial payment + evidence => payment true, evidence true', async () => {
    const client = createMockClient({
      reservations: [{ id: 4, property_id: 1, room_id: 10 }],
      ...
      payments: [{ id: 200, reservation_id: 4, status: 'SUCCESS', transaction_type: 'PAYMENT', amount: 100000 }],
  ...
  await test('scenario-6: payment exists but no evidence => payment true, evidence false', async () => {
    const client = createMockClient({
      reservations: [{ id: 6, property_id: 1, room_id: 10 }],
      ...
      payments: [{ id: 300, reservation_id: 6, status: 'SUCCESS', transaction_type: 'PAYMENT', amount: 300000 }],
      evidences: [],
      deposits: [],
      rooms: [{ id: 10, status: 'VACANT_CLEAN' }]
    });
  ...
  await test('scenario-7: active cash deposit => guarantee true', async () => {
    const client = createMockClient({
      reservations: [{ id: 7, property_id: 1, room_id: 10 }],
  ...
  await test('scenario-8: HELD identity custody => guarantee true', async () => {
    const client = createMockClient({
      reservations: [{ id: 8, property_id: 1, room_id: 10 }],
      ...
      payments: [{ id: 500, reservation_id: 8, status: 'SUCCESS', transaction_type: 'PAYMENT', amount: 500000 }],
  ...
  await test('scenario-9: returned custody only => guarantee false', async () => {
    const client = createMockClient({
      reservations: [{ id: 9, property_id: 1, room_id: 10 }],
      ...
      payments: [{ id: 600, reservation_id: 9, status: 'SUCCESS', transaction_type: 'PAYMENT', amount: 500000 }],
  ...
  await test('scenario-10: closed deposit with zero balance => guarantee false', async () => {
    const client = createMockClient({
      reservations: [{ id: 10, property_id: 1, room_id: 10 }],
      ...
      payments: [{ id: 700, reservation_id: 10, status: 'SUCCESS', transaction_type: 'PAYMENT', amount: 500000 }],
  ...
  await test('scenario-11: VACANT_DIRTY room => room_ready false', async () => {
    const client = createMockClient({
      reservations: [{ id: 11, property_id: 1, room_id: 11 }],
      ...
      payments: [{ id: 800, reservation_id: 11, status: 'SUCCESS', transaction_type: 'PAYMENT', amount: 500000 }],
      ...
      rooms: [{ id: 11, status: 'VACANT_DIRTY' }]
    });
  ...
  await test('scenario-12: VACANT_CLEAN room => room_ready true', async () => {
    const client = createMockClient({
      reservations: [{ id: 12, property_id: 1, room_id: 12 }],
      ...
      payments: [{ id: 900, reservation_id: 12, status: 'SUCCESS', transaction_type: 'PAYMENT', amount: 500000 }],
      ...
      rooms: [{ id: 12, status: 'VACANT_CLEAN' }]
    });
